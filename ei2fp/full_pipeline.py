...
if __name__ == "__main__":
    ...
    np.savetxt(BASE_DIR/"data/output/TST_maccs.txt",
               tst_ds.maccs.numpy()[:, MACCS_MASK])
    np.savetxt(BASE_DIR/"data/output/TST_fps.txt",
               tst_ds.fps.numpy()[:, FPS_MASK])
    np.savetxt(BASE_DIR/"data/output/VAL_maccs.txt",
               val_ds.maccs.numpy()[:, MACCS_MASK])
    np.savetxt(BASE_DIR/"data/output/VAL_fps.txt",
